...
func create_sprite(main_tag: StringName, sub_tag: StringName, \
	coord: Vector2i, send_signal: bool) -> TaggedSprite:
		
	var tagged_sprite: TaggedSprite = CreateSprite.create(main_tag, sub_tag, coord)
